...
\author{Laurence Kell\\ICCAT} % \And Romain Fran\c{c}ois\\\proglang{R} Enthusiasts}
...
\code{kobeSS3} and \code{kobeMFCL}). 
...
#t.=ddply(subset(sims,year %in% 2013:2022),.(year,TAC),  kobeSmry)[,c("year","TAC","green","underFished","underFishing")]
